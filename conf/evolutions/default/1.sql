...
alter table grupo add constraint fk_grupo_docente_3 foreign key (docente_dni) references usuario (dni) on delete restrict on update restrict;
create index ix_grupo_docente_3 on grupo (docente_dni);
alter table grupo_experto_problema add constraint fk_grupo_experto_problema_grupoExperto_4 foreign key (grupo_experto_id) references grupo (id) on delete restrict on update restrict;
...
alter table usuario add constraint fk_usuario_grupoExperto_12 foreign key (grupo_experto_id) references grupo (id) on delete restrict on update restrict;
create index ix_usuario_grupoExperto_12 on usuario (grupo_experto_id);
