...
create table grupo_experto_problema (
  ...
  sesion_jigsaw_id          integer,
  constraint pk_grupo_experto_problema primary key (par_id))
;
...
alter table grupo_experto_problema add constraint fk_grupo_experto_problema_grupoExperto_4 foreign key (grupo_experto_grupo_experto_id) references grupo_experto (grupo_experto_id) on delete restrict on update restrict;
create index ix_grupo_experto_problema_grupoExperto_4 on grupo_experto_problema (grupo_experto_grupo_experto_id);
alter table grupo_experto_problema add constraint fk_grupo_experto_problema_problema_5 foreign key (problema_problema_id) references problema (problema_id) on delete restrict on update restrict;
create index ix_grupo_experto_problema_problema_5 on grupo_experto_problema (problema_problema_id);
...
alter table tema add constraint fk_tema_curso_11 foreign key (curso_codigo) references curso (codigo) on delete restrict on update restrict;
create index ix_tema_curso_11 on tema (curso_codigo);
